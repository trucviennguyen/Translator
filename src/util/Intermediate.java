...
public class Intermediate {
    // 
    public static HashMap<String, Integer> maxUserIndex = new HashMap();
    public static HashSet<String> IDs = new HashSet();
    public static HashSet<String> oldPersonIDs = new HashSet();
    public static ArrayList<String> newPersonIDs = new ArrayList();
